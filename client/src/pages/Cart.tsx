    ...
    <div className='flex flex-col-reverse lg:flex-row'>
      ...
      <div className='mt-4 h-fit w-full  flex-[0.4] space-y-4 rounded-md bg-zinc-100  p-4 shadow-md md:space-y-6 lg:ml-4'>
        ...
        <div className='space-y-2 font-light md:text-xl'>
          ...
          <p className='flex items-center justify-between '>
            Total Price
            <span className='rounded-md border-2 border-amber-600 px-6 py-1 font-medium '>
              $100.00
            </span>
          </p>
        </div>

        <button className='w-full rounded-md bg-amber-600 py-2 text-center font-medium  text-zinc-100 md:text-lg'>
          Proceed to Buy
        </button>
      </div>
    </div>
